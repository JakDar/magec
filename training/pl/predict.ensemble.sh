...
OPTIONS="-m  $nmt_models $MODEL_DIR/lm1/lm.npz.best-ce-mean-words.npz --weights $nmt_weights $lm -v $MODEL_DIR/vocab.spm $MODEL_DIR/vocab.spm --mini-batch 2000 -w 10000 --beam-size 6 --normalize 1.0 --max-length 120 --max-length-crop --quiet-translation"
